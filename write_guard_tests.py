test_content = '''// packages/core/tests/test_pattern_guard.ts
...
with open('/Users/thomas/Desktop/The_Munk_Health/themunk_app/packages/core/tests/test_pattern_guard.ts', 'w') as f:
    f.write(test_content)

print("test_pattern_guard.ts written successfully")
