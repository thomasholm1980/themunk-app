  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a1f0d", color: "#f0ebe3", padding: "60px 24px", fontFamily: "ui-sans-serif, system-ui, sans-serif" }}>
      <div style={{ maxWidth: "720px", margin: "0 auto", lineHeight: 1.7 }}>
        ...
        <p><strong style={{ color: "#fff" }}>Helsedata fra wearables:</strong> Når du kobler Oura Ring eller Apple Health, henter vi hjertefrekvensvariabilitet (HRV), hvilepuls, søvndata, aktivitet og stress-score. Disse dataene er sensitive personopplysninger under GDPR Artikkel 9.</p>
        <p><strong style={{ color: "#fff" }}>Stemmedata:</strong> Når du snakker med Aria (vår stemmebaserte funksjon levert av Hume AI), behandles lyden i sanntid for å gi deg respons. Stemmeopptak lagres ikke permanent hos oss. Hume AI kan lagre korte sesjons-data i henhold til deres egen personvernerklæring.</p>
        ...
        <p><strong style={{ color: "#fff" }}>Stemme-prosessering (Hume AI):</strong> USA-basert. Data overføres til USA under EU-godkjente Standard Contractual Clauses (SCCs).</p>
        ...
        <h2 style={{ fontSize: "22px", fontFamily: '"Crimson Pro", serif', marginTop: "40px", marginBottom: "12px", color: "#D4AF37" }}>11. Endringer i denne erklæringen</h2>
        <p>Ved vesentlige endringer varsler vi deg via e-post og i appen minst 30 dager før endringen trer i kraft.</p>

        <h2 style={{ fontSize: "22px", fontFamily: '"Crimson Pro", serif', marginTop: "40px", marginBottom: "12px", color: "#D4AF37" }}>12. Kontakt</h2>
