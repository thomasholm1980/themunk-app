  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a1f0d", color: "#f0ebe3", padding: "60px 24px 120px", fontFamily: "ui-sans-serif, system-ui, sans-serif" }}>
      <div style={{ maxWidth: "720px", margin: "0 auto", lineHeight: 1.7 }}>
        ...
        <p><strong style={{ color: "#fff" }}>Health data from wearables:</strong> When you connect a supported wearable (Oura Ring, Apple Health, Garmin, Whoop, Samsung Health, Google Health Connect), we retrieve heart rate variability (HRV), resting heart rate, sleep data, activity, and stress score. These are sensitive personal data under GDPR Article 9.</p>
        <p><strong style={{ color: "#fff" }}>Voice data:</strong> When you speak with Aria (our voice feature powered by Hume AI), audio is processed in real time to give you a response. Voice recordings are not permanently stored, neither by The Munk nor by Hume AI.</p>
        ...
        <p><strong style={{ color: "#fff" }}>Voice processing (Hume AI):</strong> US-based. Data is transferred to the US under EU-approved Standard Contractual Clauses (SCCs). Hume AI processes voice data exclusively to deliver real-time analysis and does not use your data for model training.</p>
        ...
        <p><strong style={{ color: "#fff" }}>Apple HealthKit-specific:</strong> Data retrieved via Apple HealthKit is not used for advertising, marketing, sale, or sharing with data brokers, in compliance with Apple&apos;s HealthKit license terms.</p>
        ...
        <p>Health data from wearables is automatically deleted <strong style={{ color: "#fff" }}>12 months</strong> after the last registration, unless you actively renew the processing by continuing to use the service.</p>
        ...
        <h2 style={{ fontSize: "22px", fontFamily: \'"Crimson Pro", serif\', marginTop: "40px", marginBottom: "12px", color: "#D4AF37" }}>11. AI Transparency</h2>
        <p>The Munk uses AI systems (Anthropic Claude and Hume AI) to generate content based on your biometric data and voice input. In line with EU AI Act Article 50, we explicitly inform you: when you interact with Aria or receive reflections from Ask the Munk, you are communicating with an AI system. AI-generated estimates and reflections are not psychological diagnoses or medical assessments.</p>

        <h2 style={{ fontSize: "22px", fontFamily: \'"Crimson Pro", serif\', marginTop: "40px", marginBottom: "12px", color: "#D4AF37" }}>12. Changes to This Policy</h2>
        <p>For material changes, we notify you via email and in the app at least 30 days before the change takes effect.</p>

        <h2 style={{ fontSize: "22px", fontFamily: \'"Crimson Pro", serif\', marginTop: "40px", marginBottom: "12px", color: "#D4AF37" }}>13. Contact</h2>
