...
export default function LandingPage() {
  ...
  return (
    <div style={{width:'100%',minHeight:'100vh',background:'#faf8f4',fontFamily:'"Outfit",sans-serif',color:'#2a2a2a'}}>
      ...
      {/* NAV */}
      <nav style={{borderBottom:'0.5px solid rgba(42,42,42,0.08)',background:'#faf8f4',position:'sticky',top:0,zIndex:100}}>
        <div className="shell" style={{display:'flex',alignItems:'center',justifyContent:'space-between',padding:'16px 44px'}}>
          <div style={{display:'flex',alignItems:'center'}}>
            <img src="/assets/munk-logo.png" alt="The Munk" style={{height:'52px',width:'52px',objectFit:'contain',borderRadius:'50%'}} />
            <span style={{fontFamily:'"Lora",serif',fontSize:'15px',fontWeight:600,letterSpacing:'3px',color:'#1a1a1a',textTransform:'uppercase' as const,marginLeft:'12px'}}>
              The Munk<span style={{fontSize:'9px',color:'#c8a84b',letterSpacing:'2px',fontFamily:'"Outfit",sans-serif',fontWeight:400}}>AI</span>
            </span>
          </div>
          <a href="#signup" style={{fontSize:'11px',letterSpacing:'2px',textTransform:'uppercase' as const,color:'rgba(42,42,42,0.5)',fontWeight:500,textDecoration:'none'}}>Bli med i testen</a>
        </div>
      </nav>

      {/* HERO */}
      <div className="shell">
        <div className="hero-grid" style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'48px',padding:'64px 0 48px',alignItems:'start'}}>
          <div>
            <div style={{display:'flex',alignItems:'center',gap:'8px',fontSize:'12px',color:'#2d5a3d',fontWeight:500,marginBottom:'24px'}}>
              <span style={{width:'7px',height:'7px',borderRadius:'50%',background:'#c8a84b',display:'inline-block',flexShrink:0}}></span>
          ...
          <div id="signup">
            <div style={{background:'#fff',border:'0.5px solid rgba(42,42,42,0.1)',borderRadius:'8px',padding:'32px 28px'}}>
              ...
              {status === 'success' ? (
                <div>
                  <div style={{display:'flex',alignItems:'center',gap:'8px',fontSize:'11px',letterSpacing:'2px',textTransform:'uppercase' as const,color:'#2d5a3d',fontWeight:500,marginBottom:'16px'}}>
                    <span style={{width:'8px',height:'8px',borderRadius:'50%',background:'#2d5a3d'}}></span>Registrert
                  </div>
                  <div style={{fontFamily:'"Lora",serif',fontSize:'24px',color:'#1a1a1a',marginBottom:'10px',fontWeight:600}}>Takk — du er med.</div>
                ...
                <form onSubmit={handleSubmit}>
                  <input type="email" placeholder="Din e-postadresse" value={email} onChange={e => setEmail(e.target.value)} required disabled={status==='loading'}
                    style={{width:'100%',border:'0.5px solid rgba(42,42,42,0.2)',borderRadius:'4px',padding:'12px 16px',fontFamily:'"Outfit",sans-serif',fontSize:'14px',color:'#2a2a2a',background:'#faf8f4',marginBottom:'12px',outline:'none'}} />
                  <button type="submit" disabled={status==='loading'}
                    style={{width:'100%',background:'#2d5a3d',color:'#f0ece2',fontFamily:'"Outfit",sans-serif',fontSize:'14px',fontWeight:500,padding:'14px',border:'none',borderRadius:'4px',cursor:'pointer'}}>
                    {status==='loading' ? 'Sender...' : 'Bli med i testen'}
                  </button>
                  {status==='error' && <div style={{fontSize:'12px',color:'#b94040',marginTop:'8px'}}>Noe gikk galt. Prøv igjen.</div>}
      ...
      {/* BRIEF */}
      <div style={{background:'#2d3d2d',padding:'56px 0'}}>
        <div className="shell">
          <div style={{maxWidth:'680px'}}>
            <div style={{fontSize:'10px',letterSpacing:'3px',textTransform:'uppercase' as const,color:'rgba(240,235,224,0.35)',marginBottom:'16px'}}>Eksempel — daglig brief</div>
            <div style={{display:'inline-block',background:'rgba(200,168,75,0.2)',color:'#c8a84b',fontSize:'10px',letterSpacing:'2px',textTransform:'uppercase' as const,padding:'4px 12px',borderRadius:'2px',marginBottom:'22px',border:'0.5px solid rgba(200,168,75,0.3)'}}>Moderat stress</div>
            ...
            <div style={{display:'flex',gap:'32px',paddingTop:'20px',borderTop:'0.5px solid rgba(240,235,224,0.1)',flexWrap:'wrap' as const}}>
      ...
      {/* CTA */}
      <div style={{background:'#1e2e1e',padding:'64px 0'}}>
        <div className="shell">
          ...
          <a href="#signup" style={{background:'transparent',color:'#f0ece2',fontFamily:'"Outfit",sans-serif',fontSize:'13px',fontWeight:500,padding:'12px 28px',border:'0.5px solid rgba(240,235,224,0.4)',borderRadius:'2px',display:'inline-block',textDecoration:'none'}}>Bli med i testen</a>
        </div>
      </div>

      {/* FOOTER */}
      <div style={{background:'#1a2a1a',padding:'28px 0',borderTop:'0.5px solid rgba(240,235,224,0.06)'}}>
        <div className="shell">
