  ...
  return (
    <div style={{ width:'100%', minHeight:'100vh', background:'linear-gradient(160deg, #081609 0%, #112915 100%)', fontFamily:'"Outfit",sans-serif', color:'#fff', position:'relative', overflow:'hidden' }}>
      ...
      <div className="shell" style={{ position:'relative',zIndex:10 }}>
        <div className="hero-grid" style={{ display:'grid',gridTemplateColumns:'1fr 1fr',gap:'56px',padding:'72px 0 56px',alignItems:'start' }}>
          <div>
            ...
            <p style={{ fontSize:'16px',lineHeight:1.75,color:'rgba(255,255,255,0.55)',fontWeight:300,marginBottom:'40px',maxWidth:'400px' }}>
          ...
          <div id="signup">
            <div style={{ background:'rgba(255,255,255,0.03)',backdropFilter:'blur(24px)',WebkitBackdropFilter:'blur(24px)',border:'1px solid rgba(255,255,255,0.08)',borderRadius:'32px',padding:'36px 32px',position:'relative',overflow:'hidden',marginBottom:'16px' }}>
              ...
              <div style={{ fontSize:'13px',color:'rgba(255,255,255,0.40)',marginBottom:'28px',fontWeight:300 }}>Vi inviterer et begrenset antall til å teste The Munk.</div>
              {status === 'success' ? (
                <div>
                  ...
                  <div style={{ fontSize:'14px',color:'rgba(255,255,255,0.50)',lineHeight:1.7,fontWeight:300 }}>Vi åpner gradvis for testbrukere.<br />Du får beskjed når vi er klare.</div>
                </div>
              ) : (
            ...
            <div style={{ background:'rgba(255,255,255,0.03)',backdropFilter:'blur(24px)',WebkitBackdropFilter:'blur(24px)',border:'1px solid rgba(255,255,255,0.08)',borderRadius:'24px',padding:'24px',position:'relative',overflow:'hidden' }}>
              ...
              <div style={{ display:'flex',gap:'24px',paddingTop:'14px',borderTop:'1px solid rgba(255,255,255,0.06)' }}>
                {[{v:'44 ms',l:'HRV (Oura)'},{v:'57 bpm',l:'Hvilepuls (Oura)'}].map(s => (
                  <div key={s.l}>
                    <div style={{ fontSize:'18px',fontFamily:'"Crimson Pro",serif',fontStyle:'italic',color:'rgba(255,255,255,0.85)',marginBottom:'2px' }}>{s.v}</div>
                    <div style={{ fontSize:'10px',color:'rgba(255,255,255,0.30)',letterSpacing:'0.15em',textTransform:'uppercase' as const }}>{s.l}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        <div className="cards-grid" style={{ display:'grid',gridTemplateColumns:'1fr 1fr',gap:'12px',paddingBottom:'64px' }}>
          {[
            ...
            <div key={c.t} style={{ background:'rgba(255,255,255,0.03)',backdropFilter:'blur(16px)',border:'1px solid rgba(255,255,255,0.07)',borderRadius:'20px',padding:'24px 20px' }}>
              <div style={{ fontFamily:'"Crimson Pro",serif',fontSize:'16px',color:'#fff',marginBottom:'8px',fontWeight:500 }}>{c.t}</div>
              <div style={{ fontSize:'13px',color:'rgba(255,255,255,0.45)',lineHeight:1.65,fontWeight:300 }}>{c.b}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <div style={{ borderTop:'1px solid rgba(255,255,255,0.06)',padding:'64px 0',position:'relative',zIndex:10 }}>
        <div className="shell">
          <div style={{ fontFamily:'"Crimson Pro",serif',fontSize:'38px',color:'#fff',fontWeight:400,marginBottom:'12px' }}>Gratis i testperioden</div>
          <div style={{ fontSize:'14px',color:'rgba(255,255,255,0.40)',marginBottom:'32px',fontWeight:300 }}>Begrenset antall plasser. Ingen binding.</div>
      ...
      <div style={{ borderTop:'1px solid rgba(255,255,255,0.05)',padding:'28px 0',position:'relative',zIndex:10 }}>
        <div className="shell">
          <div style={{ fontSize:'13px',color:'rgba(255,255,255,0.30)',marginBottom:'6px' }}>Følg utviklingen av The Munk</div>
          <div style={{ fontSize:'12px',color:'rgba(255,255,255,0.25)',marginBottom:'10px' }}>Jeg deler hvordan stress faktisk ser ut i kroppen — hver dag.</div>
