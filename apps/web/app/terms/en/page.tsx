  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a1f0d", color: "#f0ebe3", padding: "60px 24px", fontFamily: "ui-sans-serif, system-ui, sans-serif" }}>
      <div style={{ maxWidth: "720px", margin: "0 auto", lineHeight: 1.7 }}>
        ...
        <h2 style={{ fontSize: "22px", fontFamily: '"Crimson Pro", serif', marginTop: "40px", marginBottom: "12px", color: "#D4AF37" }}>1. Who We Are</h2>
        ...
        <p>You must be at least <strong style={{ color: "#fff" }}>18 years old</strong> to use The Munk. By registering, you confirm that you meet this requirement.</p>

        <h2 style={{ fontSize: "22px", fontFamily: '"Crimson Pro", serif', marginTop: "40px", marginBottom: "12px", color: "#D4AF37" }}>4. Account</h2>
        <p>You are responsible for keeping your login credentials confidential and for all activity under your account. Notify us immediately if you suspect unauthorized access.</p>

        <h2 style={{ fontSize: "22px", fontFamily: '"Crimson Pro", serif', marginTop: "40px", marginBottom: "12px", color: "#D4AF37" }}>5. Permitted Use</h2>
        <p>You agree to use The Munk only for personal, non-commercial purposes, and not to:</p>
        <ul style={{ paddingLeft: "20px", marginBottom: "16px" }}>
          <li>Attempt to reverse-engineer or hack the app</li>
          <li>Use the app for unlawful purposes</li>
          <li>Transmit malicious code or viruses</li>
          <li>Scrape data or automate access without written consent</li>
          <li>Share the account with others</li>
        </ul>
        ...
        <h2 style={{ fontSize: "22px", fontFamily: '"Crimson Pro", serif', marginTop: "40px", marginBottom: "12px", color: "#D4AF37" }}>10. Limited Liability</h2>
        <p>The Munk is provided &quot;as is&quot;. We make no guarantees that the service will always be available, error-free, or fit your specific needs. To the extent permitted by law, our liability is limited to the amount you have paid for the service in the past 12 months (for free use: NOK 0).</p>
        <p>We are not liable for indirect losses, lost profits, or damages resulting from decisions you have made based on information from the app.</p>

        <h2 style={{ fontSize: "22px", fontFamily: '"Crimson Pro", serif', marginTop: "40px", marginBottom: "12px", color: "#D4AF37" }}>11. Termination</h2>
        <p>You can delete your account at any time. We may suspend or terminate your access in case of breach of these terms, with reasonable notice where possible.</p>

        <h2 style={{ fontSize: "22px", fontFamily: '"Crimson Pro", serif', marginTop: "40px", marginBottom: "12px", color: "#D4AF37" }}>12. Changes to the Service and Terms</h2>
        <p>We may modify the service and these terms. Material changes will be communicated at least 30 days before they take effect. Continued use after changes is considered acceptance.</p>

        <h2 style={{ fontSize: "22px", fontFamily: '"Crimson Pro", serif', marginTop: "40px", marginBottom: "12px", color: "#D4AF37" }}>13. Governing Law and Jurisdiction</h2>
        <p>These terms are governed by Norwegian law. Any disputes shall be resolved in Oslo District Court.</p>

        <h2 style={{ fontSize: "22px", fontFamily: '"Crimson Pro", serif', marginTop: "40px", marginBottom: "12px", color: "#D4AF37" }}>14. Contact</h2>
        <p>Questions about these terms? Contact <a href="mailto:thomas@themunk.ai" style={{ color: "#D4AF37" }}>thomas@themunk.ai</a>.</p>
