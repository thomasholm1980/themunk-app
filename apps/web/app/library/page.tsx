...
const CARDS: LibraryCard[] = [
  ...
  { id: 'video-1', type: 'video', source: 'YOUTUBE · VIDEO', title: 'Tools for Managing Stress & Anxiety', description: 'Huberman Lab kortversjon. Forklarer stressrespons, nervesystem og konkrete verktøy du kan bruke i dag.', url: 'https://www.youtube.com/watch?v=tLRcs7vne4A', duration: '30 min · Engelsk' },
  ...
  { id: 'article-1', type: 'article', source: 'PULSKUREN.NO · ARTIKKEL', title: 'Introduksjon til HRV-mestring', description: 'Dr. Torkil Færøs nettsted om HRV, optimal stressbalanse og restitusjon. Norges nærmeste svar på The Munk sitt univers.', url: 'https://pulskuren.no', duration: 'Lang · Norsk' },
  ...
  { id: 'podcast-2', type: 'podcast', source: 'PETER ATTIA · PODCAST', title: 'HRV: Mål, tolke og bruk', description: 'Peter Attia og Joel Jamieson går dypt inn i HRV — hva tallene betyr og hvordan restitusjon henger sammen med stressnivå.', url: 'https://peterattiamd.com/joeljamieson3/', duration: 'Lang · Engelsk' },
  { id: 'video-2', type: 'video', source: 'TED · VIDEO', title: 'Sleep is your superpower', description: 'Matt Walker forklarer søvn og stressloopen på 20 minutter. Kortfattet, faktabasert og direkte relevant for deg som vil restituere bedre.', url: 'https://www.youtube.com/watch?v=5MuIMqhT8pM', duration: '20 min · Engelsk' },
    ...
    <div style={{ minHeight: '100vh', background: `linear-gradient(160deg, ${atm.gradientFrom} 0%, ${atm.gradientTo} 100%)`, transition: 'background 3s ease-in-out', color: '#fff', paddingBottom: '96px' }}>
      ...
      <div style={{ maxWidth: '384px', margin: '0 auto', padding: '0 16px', position: 'relative', zIndex: 10 }}>
        <div style={{ paddingTop: '20px', paddingBottom: '8px' }}>
          ...
          <div style={{ fontSize: '26px', fontWeight: 600, fontFamily: 'var(--font-crimson), ui-serif, Georgia, serif', marginBottom: '20px' }}>Kuratert for deg</div>
        </div>
