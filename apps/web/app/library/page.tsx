...
const CARDS: LibraryCard[] = [
  ...
  { id: 'ro-pust', type: 'article', source: 'MUNKENS INNSIKT', title: 'Hva skjer i kroppen når du puster rolig?', description: 'Når du puster ut lenger enn du puster inn, sender du et direkte signal til nervesystemet om at faren er over. Dette senker kortisolnivået og skifter kroppen fra beredskap til restitusjon. Forskning viser at kontrollert pust kan redusere stress-intensitet for opptil 67% av brukerne.' },
