...
with open('/Users/thomas/Desktop/The_Munk_Health/themunk_app/apps/web/app/check-in/page.tsx', 'w') as f:
    f.write(content)

print("check-in/page.tsx updated with morningInsight rendering")
